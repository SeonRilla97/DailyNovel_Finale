...
<template>
  <div v-if="defineRef.loading" class="dot-overtaking"></div>

  <div v-if="!defineRef.isInit" class="editor-wrap" @click="onclickedHandler">
    ...
    <div class="editor-attribue-box">
      ...
      <div class="editor-attribue dropdown">
        ...
        <!-- :checkTag ="diaryTag" -->
        <div @click="DropdownHandler" class="dropdown-content dropdown-feeling-content">
      ...
      <div class="editor-attribue dropdown">
        ...
        <!-- :checkTag ="diaryFeel" -->
        <div @click="DropdownHandler" class="dropdown-content">
      ...
      <div class="editor-attribue dropdown">
        ...
        <div @click="DropdownHandler" class="dropdown-content dropdown-honestier-content">
      ...
      <div @click="delButton" class="add-btn">-
      </div>

    </div>

    <div class="editor-title">
      <header contenteditable="true" class="editor-title-content editor-header" @blur="editHandler">
        <!-- {{titleDate+'의 일기'}} -->
        {{ diaryRef.title }}
      </header>
      <div v-if="isSharedref" class="editor-share">공유 중</div>
      <div v-if="!isSharedref" class="editor-share .active">공유 여부</div>

      <input type="checkbox" id="toggle" class="toggle2" hidden>
      <label v-if="!isSharedref" @click="toggleClickHandler" for="toggle" class="toggleSwitch">
    ...
    <div class="editor-main-quill">
      <main class="editor-main" @blur="editHandlerContent">
        <!-- <quill2/> -->
        <!-- <quill
          class="editor-quill"
        ...
        <quill3 @quillOutput="quillOutputValue" :loadDiaryContent="diaryRef.content" />
        <!-- :quillOutputHnadler = "quillOutputValueHandler" -->

      </main>

      <div class="editor-sub-button editor-sub">
      ...
      <div class="img-map-container">
        ...
        <!-- 맵 삽입칸 -->
        <div v-if="mapToggle" class="mapToggle-map editor-sub">
