...
<section class="collection-container">
    <header>
        <div class="pdl-5 h2 font-bold">컬렉션</div>
    </header>
        ...
        <div class="slide-container" >
            <div class="create-collection-form box">
                <transition name="fade">
                    <div class="box register-form" v-show="registerMenuController">
                ...
                <transition name="fade">
                    <div class="box register-btn" v-show="!registerMenuController" @click="registerFromHandler">
